...
if __name__ == '__main__':
    s = Port_delivery('2020-02-25 18:12:00','egCFpcGpliNUyIDjtwjNhIJeBSWiSzYJ')  # sys.argv[1],sys.argv[2],sys.argv[3]
    print(s.get_delivery())
