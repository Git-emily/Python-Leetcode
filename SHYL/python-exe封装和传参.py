...
class json2sql:
    def me_json2sql(self,file_path):
        ...
        for j in tmp_file:
            sql_value = (  # i["count"],i["iostock_price_num"],i["unit_cost_num"],
        ...
        sql = "insert into SHYL(iostock_id,iostock_bn,branch_bn,branch_name,bn,name,barcode,nums,type,iostock_time,memo,original_bn,iostock_price,unit_cost,appropriation_no) " \
...
if __name__ == '__main__':
    s = json2sql()
    s.me_json2sql(sys.argv[1])  # C:\Users\Administrator\PycharmProjects\SHYLPro\Data2.json
